...
from thesis_vla.common.paths import TRAIN_OUTPUT_DIR
...
def main():
    ...
    local_ee6d_base = str(TRAIN_OUTPUT_DIR / "xvla-base_finetuned_soarm101_pickplace_10d_20260225_105259" / "checkpoints")
    local_joint_base = str(TRAIN_OUTPUT_DIR / "xvla-base_finetuned_soarm101_pickplace_10d_20260225_162713" / "checkpoints")
