...
ALL_CEDIRNET_GUIDANCE = FOLD_CEDIRNET_GUIDANCE + BOX_CEDIRNET_GUIDANCE + FOLD_BOTH_CEDIRNET_DINO_GUIDANCE + BOX_BOTH_CEDIRNET_DINO_GUIDANCE

EXPERIMENTS = ALL_CEDIRNET_GUIDANCE
